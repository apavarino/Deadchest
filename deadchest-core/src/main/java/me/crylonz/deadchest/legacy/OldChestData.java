...
public final class OldChestData implements ConfigurationSerializable {
    ...
    public OldChestData(OldChestData chest) {
    ...
    public OldChestData(final Inventory inv,
    ...
    public static OldChestData deserialize(final Map<String, Object> map) {
    ...
    public static void migrateOldChestData() {
        if (fileManager.getChestDataFile().exists()) {
            ...
            try {
                ...
                if (tmp != null) {
                    for (OldChestData oldChestData : tmp) {
                        chestDataList.add(new ChestData(
                                ...
                                oldChestData.getPlayerUUID(),
                                oldChestData.getChestDate(),
                                oldChestData.isInfinity(),
                ...
                throw new RuntimeException("Unable to migrate chestData.yml file : " + exception.getMessage(), exception);
            }
        }
    }
}